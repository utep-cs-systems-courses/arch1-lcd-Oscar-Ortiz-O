...
void drawStar(u_char centerCol, u_char centerRow, u_int colorBGR)
{
  int step = 0;
  int doubleStep = 0;
  int offset = 25;
  ...
  for(int i = 0; i < 20; i++) {
    ...
    // Lines for the top point of the star
    drawPixel(centerCol + doubleStep, centerRow + step - offset, colorBGR);
    drawPixel(centerCol - doubleStep, centerRow + step - offset, colorBGR);

    // Lines for the bottom point of the star
    drawPixel(centerCol + doubleStep, centerRow - step + offset, colorBGR);
    drawPixel(centerCol - doubleStep, centerRow - step + offset, colorBGR);

    // Lines for the left point of the star
    drawPixel(centerCol + step - offset, centerRow + doubleStep, colorBGR);
    drawPixel(centerCol + step - offset, centerRow - doubleStep, colorBGR);

    // Lines for the right point of the star
    drawPixel(centerCol - step + offset, centerRow + doubleStep, colorBGR);
    drawPixel(centerCol - step + offset, centerRow - doubleStep, colorBGR);
